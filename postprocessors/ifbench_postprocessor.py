"""IFBench IFEval postprocessor for processing instruction following task predictions."""
import logging
...
class IfbenchPostprocessor(Postprocessor):
    """
    Postprocessor for IFBench Eval model predictions.
    """
    ...
    def process(
        ...
        """
        logger.info("Processing predictions with IFBenchPostprocessor...")
